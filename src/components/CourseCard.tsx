...
const CourseCard: React.FC<CourseCardProps> = ({
  ...
  return (
    ...
    >
      {/* Thumbnail */}
      <div className="relative h-48 bg-linear-to-br from-[#243E36FF]/75 to-[#47126b]/85 overflow-hidden">
        {course.thumbnail && (
          <img
      ...
      <div className="p-6">
        ...
        {!isLocked && !isEnrolled && onEnroll && (
          <button
            ...
            className="w-full bg-[#243E36FF] hover:bg-[#243E36FF]/85 text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200"
          >
            Enroll Now
          </button>
        )}
