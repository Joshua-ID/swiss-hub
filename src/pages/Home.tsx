          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-5">
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              ...
              <p className="text-gray-600">
                Access high-quality courses from expert instructors across
                various domains
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 text-center">
              <div className="bg-[#47126b]/5 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
